...
plot 'logtable1.csv' using 1:3 with linespoints title '2 intervals' , \
'logtable2.csv' using 1:3 with linespoints title '2 intervals' , \
'logtable3.csv' using 1:3 with linespoints title '3 intervals' , \
'logtable5.csv' using 1:3 with linespoints title '5 intervals' , \
'logtable7.csv' using 1:3 with linespoints title '7 intervals' , \
'logtable10.csv' using 1:3 with linespoints title '10 intervals' , \
'logtable14.csv' using 1:3 with linespoints title '14 intervals' , \
'logtable28.csv' using 1:3 with linespoints title '28 intervals' , \
'logtable56.csv' using 1:3 with linespoints title '56 intervals' , \
'logtable100.csv' using 1:3 with linespoints title '100 intervals' 
