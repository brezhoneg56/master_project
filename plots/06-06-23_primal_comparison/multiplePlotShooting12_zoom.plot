...
plot 'logtable2.csv' using 1:($2*1e07) with linespoints title '2 intervals' , \
'logtable3.csv' using 1:($2*1e07) with linespoints title '3 intervals' , \
'logtable5.csv' using 1:($2*1e07) with linespoints title '5 intervals' , \
'logtable7.csv' using 1:($2*1e07) with linespoints title '7 intervals' , \
'logtable10.csv' using 1:($2*1e07) with linespoints title '10 intervals'
