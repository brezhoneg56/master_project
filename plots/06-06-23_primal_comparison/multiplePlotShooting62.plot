...
'14_intervals_05-06-23/logtable14.csv' using 6:2 with linespoints title '14 intervals' , \
'28_intervals_05-06-23/logtable28.csv' using 6:2 with linespoints title '28 intervals' , \
'56_intervals_05-06-23/logtable56.csv' using 6:2 with linespoints title '56 intervals' , \
'100_intervals_05-06-23/logtable100.csv' using 6:2 with linespoints title '100 intervals' 
