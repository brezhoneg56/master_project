...
def prepareShootingUpdate(folder_name, sweep_name, interval_name, k, i):#should start from sweep2, after interval2 is done
    ...
    src_violet_folder=primitive_path+folder_name+"/"+sweep_name+"/"+interval_name+"/"+str(theta+(i-1)*deltaT)+"/"
    ...
    print("Copy code RED.\n")
    src_red_folder=primitive_path+folder_name+"/"+sweep_name+"/"+interval_name+"/"+str(theta+i*deltaT)+"/"
    ...
    src_green_folder=primitive_path+folder_name+"/"+next_sweep+"/"+interval_name+"/"+str(theta(i-1)*deltaT)+"/"
